...
static const char col_bluez[]       = "#15539E";
static const char col_green[]       = "#50F97B";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_green, col_gray1, col_bluez },
};
...
static const char *light_up[]     = { "/usr/local/bin/inc-brightness.sh", NULL };
static const char *light_down[]   = { "/usr/local/bin/dec-brightness.sh", NULL };
static const char *text_grab[]    = { "/usr/local/bin/text-grab", NULL };
...
static const Key keys[] = {
  ...
  /* remaining layouts */
  { MODKEY,                       XK_v,      setlayout,      {.v = &layouts[3]} },  /* dwindle */
  { MODKEY,                       XK_y,      setlayout,      {.v = &layouts[4]} },  /* deck */
  { MODKEY,                       XK_n,      setlayout,      {.v = &layouts[5]} },  /* bstack */
  { MODKEY,                       XK_x,      setlayout,      {.v = &layouts[6]} },  /* bstackhoriz */
  { MODKEY,                       XK_g,      setlayout,      {.v = &layouts[7]} },  /* grid */
  { MODKEY,                       XK_r,      setlayout,      {.v = &layouts[8]} },  /* nrowgrid */
  { MODKEY,                       XK_slash,  setlayout,      {.v = &layouts[9]} },  /* horizgrid */
  { MODKEY,                       XK_equal,  setlayout,      {.v = &layouts[10]} }, /* gaplessgrid */
  { MODKEY,                       XK_c,      setlayout,      {.v = &layouts[11]} }, /* centeredmaster */
  { MODKEY,                       XK_o,      setlayout,      {.v = &layouts[12]} }, /* centeredfloatingmaster */
  { MODKEY,                       XK_backslash,setlayout,    {.v = &layouts[13]} }, /* floating (NULL) */
};
